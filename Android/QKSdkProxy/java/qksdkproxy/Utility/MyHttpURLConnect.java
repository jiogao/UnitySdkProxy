...
public class MyHttpURLConnect {
    ...
    public static void doPost(final String urlstr, final String param, final HttpHander handler) {
        Log.i("MyHttpURLConnect","doPost: " + urlstr + "?" + param);
        String result = "";
        new Thread() {
            @Override
            public void run() {
...
//                        handler.onResult(result);
                        CallHandlerOnUiThread(handler, result);
    ...
    static void CallHandlerOnUiThread(final HttpHander handler, String result) {
